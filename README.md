...
- **[ContextStream](https://github.com/contextstream/mcp-server)** - Shared project context for AI coding agents: hosted MCP with code search, decisions, lessons, and plans ([contextstream.io](https://contextstream.io))
