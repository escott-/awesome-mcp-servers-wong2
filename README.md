...
- **[ContextStream](https://github.com/contextstream/mcp-server)** - Shared project context for AI coding agents across Cursor, Claude Code, Codex, Grok, Windsurf, and other MCP clients ([website](https://contextstream.io), [benchmarks](https://contextstream.io/benchmarks)).
